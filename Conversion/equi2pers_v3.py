...
def equi2pers(erp_img, fov, nrows, patch_size):
    ...
    #     num_rows = 12
    #     num_cols = [3, 8, 12, 12, 8, 3]
    #     phi_centers = [-82.5, -67.5, -52.5, -37.5, -22.5, -7.5, 7.5, 22.5, 37.5, 52.5, 67.5, 82.5]
...
#     pers = equi2pers(img_new, fov=(60, 60), nrows=6, patch_size=(64, 64))
#     pers = pers[0].numpy()
#     print("pers: ",pers.shape)
#     pers = pers[0].transpose(3,1,2,0).astype(np.uint8)
#     print("pers: ",pers.shape)
#     for i in range(45):
#         cv2.imwrite('test/pers_'+str(i)+'.png', pers[i])
#     exit()
#     print(pers.shape)    
